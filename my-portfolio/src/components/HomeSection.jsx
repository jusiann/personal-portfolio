  ...
  return (
    <div className="relative w-[90%] mx-auto min-h-[calc(100vh-8rem)] flex items-center justify-center pt-32 pb-8">
        ...
        <div className="flex items-stretch gap-12 w-full max-w-7xl">
            ...
            {/* NAME SURNAME TITLE */}
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-foreground mb-2 tracking-tight text-center md:text-left">
                {translate('home.name')}{' '}
            ...
            <p className="text-lg md:text-xl text-foreground/60 font-code h-7 mb-6 text-center md:text-left">
