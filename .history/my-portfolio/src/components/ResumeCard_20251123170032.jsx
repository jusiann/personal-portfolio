                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-3">
                                ...
                                <div className="flex items-start gap-3 p-2 pl-3 rounded-lg bg-primary/2 border border-primary/10 hover:bg-primary/4 transition-colors duration-200">
                                    ...
                                    <span className="text-foreground/80 text-sm">{t('birth_day')} {t('february')} {t('birth_year')}</span>
                                </div>
                                <div className="flex items-start gap-3 p-2 pl-3 rounded-lg bg-primary/2 border border-primary/10 hover:bg-primary/4 transition-colors duration-200">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-3 p-2 pl-3 rounded-lg bg-primary/2 border border-primary/10 hover:bg-primary/4 transition-colors duration-200">
                                    ...
                                    <span className="text-foreground/80 text-sm">{t('email_address')}</span>
                                </div>
                                <div className="flex items-start gap-3 p-2 pl-3 rounded-lg bg-primary/2 border border-primary/10 hover:bg-primary/4 transition-colors duration-200">
                                    <FiPhone className="text-primary mt-0.5 shrink-0" />
                                    <span className="text-foreground/80 text-sm">{t('phone_number')}</span>
                                </div>
                                <div className="flex items-start gap-3 p-2 pl-3 rounded-lg bg-primary/2 border border-primary/10 hover:bg-primary/4 transition-colors duration-200">
                                    <FiGlobe className="text-primary mt-0.5 shrink-0" />
                                    <span className="text-foreground/80 text-sm">{t('turkish')} ({t('native')}), {t('english')} ({t('english_level')})</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="border-l-4 border-primary pl-4">
                                ...
                                <p className="text-sm text-foreground/60">
                                    {t('education_university_start')} - {t('present')}
                                </p>
                            </div>
                            <div className="border-l-4 border-primary/50 pl-4">
                                ...
                                <p className="text-sm text-foreground/60">
                                    {t('education_highschool_start')} - {t('education_highschool_end')}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            <div className="border-l-4 border-primary pl-4">
                                ...
                                <p className="text-sm text-foreground/60 mb-2">
                                    {t('experience_yapiradar_start')} - {t('present')}
                                </p>
