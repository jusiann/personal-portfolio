...
const ProfileImage = ({ size = "default" }) => {
    ...
    return (
        <div className={size === "large" ? "flex justify-center" : "flex justify-center mb-8"}>
            <div className="relative group animate-pulse-subtle">
                ...
                <div className={`relative ${sizeClasses} rounded-full overflow-hidden border-4 border-primary/20 shadow-2xl group-hover:scale-105 transition-transform duration-300`}>
                    <img
