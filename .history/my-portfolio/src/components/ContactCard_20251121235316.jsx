...
export const ContactCard = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const mailtoLink = `mailto:adilefe257@gmail.com?subject=${encodeURIComponent(formData.firstName + " " + formData.lastName + " - " + subject)}&body=${encodeURIComponent(formData.message)}`;
