...
export const ContactCard = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const mailtoLink = `mailto:adilefe257@gmail.com?subject=${encodeURIComponent(subject + " - " + formData.firstName + " " + formData.lastName)}&body=${encodeURIComponent(formData.message)}`;
