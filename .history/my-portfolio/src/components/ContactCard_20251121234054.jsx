                        ...
                        <div className="mt-8 pt-8 border-t border-foreground/10">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 p-3 rounded-lg bg-primary/5 border border-primary/10 hover:bg-primary/10 transition-colors duration-200">
                                    <HiOutlineMail className="text-primary text-xl shrink-0" />
                                    <div className="min-w-0">
                                        <p className="text-xs text-foreground/60 mb-1">{t('email')}</p>
                                        <p className="text-sm text-foreground/90 font-medium truncate">adilefe257@gmail.com</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-3 rounded-lg bg-primary/5 border border-primary/10 hover:bg-primary/10 transition-colors duration-200">
                                    <BsTelephone className="text-primary text-xl shrink-0" />
                                    <div className="min-w-0">
                                        <p className="text-xs text-foreground/60 mb-1">{t('phone')}</p>
                                        <p className="text-sm text-foreground/90 font-medium">+90 545 676 43 24</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-3 rounded-lg bg-primary/5 border border-primary/10 hover:bg-primary/10 transition-colors duration-200 md:col-span-2">
                                    <FiMapPin className="text-primary text-xl shrink-0" />
                                    <div className="min-w-0">
                                        <p className="text-xs text-foreground/60 mb-1">{t('location')}</p>
                                        <p className="text-sm text-foreground/90 font-medium">Kartal / İstanbul, Turkey</p>
                                    </div>
                                </div>
                            </div>
                        </div>
