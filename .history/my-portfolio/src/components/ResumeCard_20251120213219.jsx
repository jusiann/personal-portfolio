...
import { 
    ...
    SiC, SiCplusplus, SiCsharp, SiJava, SiPython, SiPostgresql, SiMongodb,
    SiGit, SiVisualstudiocode, SiFigma, SiPostman, SiBlender, SiUnity
} from 'react-icons/si';
            ...
            case 'skills': {
                ...
                const skillsData = {
                    ...
                    backend: [
                        ...
                        { name: 'C#', iconData: SimpleIcons.siCsharp },
                        { name: 'Java', iconData: SimpleIcons.siJava },
