      ...
      if (currentTime - lastCheckTime.current > 300) {
        ...
        setNodes((prevNodes) => {
              ...
              if (distance < maxDistance) {
                ...
                if (Math.random() < 0.45) {
                  newConnections.push({
                    ...
                    x2: prevNodes[j].x,
                    y2: prevNodes[j].y,
                    opacity: (1 - distance / maxDistance) * 0.95, // Çok daha belirgin
                    birthTime: currentTime,
                    lifetime: 4000 + Math.random() * 3000, // 4-7 saniye (daha uzun ömür)
                  });
                }
              }
            }
          ...
          setConnections((prevConns) => {
            ...
            // Yeni çizgileri ekle, ama max 100 çizgi olsun
