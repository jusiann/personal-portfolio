...
export const PageTransition = ({ children }) => {
    return (
        <>
            ...
            {/* Sol Üçgen (Ters) - başlangıçta ekran dışında, exit'te ortaya gelir */}
            <motion.div
                ...
                initial={{ x: '-100%' }}
                animate={{ x: '-100%' }}
                exit={{ x: '0%', transition: { duration: 0.7, ease: [0.65, 0, 0.35, 1] } }}
            />

            {/* Sağ Üçgen (Düz) - başlangıçta ekran dışında, exit'te ortaya gelir */}
            <motion.div
                className="fixed inset-0 bg-background z-100 pointer-events-none"
                style={{
