    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'skills': {
                const Icon = ({ icon }) => {
                    return (
                        <svg viewBox="0 0 24 24" fill="currentColor" dangerouslySetInnerHTML={{ __html: icon.path }} />
                    );
                };
                ...
                const skillsData = {
                    ...
                    backend: [
                        ...
                        { name: 'Java', icon: SimpleIcons.siOpenjdk },
                    ...
                    tools: [
                        ...
                        { name: 'VS Code', icon: SimpleIcons.siVisualstudiocode },
                        { name: 'Figma', icon: SimpleIcons.siFigma },
                        { name: 'Postman', icon: SimpleIcons.siPostman },
                        { name: 'Blender', icon: SimpleIcons.siBlender },
                        { name: 'Unity', icon: SimpleIcons.siUnity },
                    ]
                };
