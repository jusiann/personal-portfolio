        ...
        <div className="relative w-[90%] mx-auto min-h-[calc(100vh-8rem)] flex flex-col items-center justify-center pt-32 pb-8">
            <div className="w-full max-w-6xl">
                ...
                <div className="mb-6 animate-fade-in">
                    <div className="flex overflow-x-auto justify-center bg-background/20 backdrop-blur-sm rounded-lg border border-primary/20 p-1">
                        {tabs.map((tab, index) => (
                            <button
                                key={tab.id}
                                onClick={() => setActiveTab(tab.id)}
                                className={cn(
                                    "px-6 py-2 text-sm font-medium transition-all duration-200 rounded-md min-w-fit",
