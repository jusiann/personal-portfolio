...
export const Navbar = () => {
  ...
  const navItems = [
    { name: translations[lang].home, href: `/${lang}`, icon: '🏠' },
    { name: translations[lang].skills, href: `/${lang}/skills`, icon: '⚡' },
    { name: translations[lang].projects, href: `/${lang}/projects`, icon: '🚀' },
    { name: translations[lang].contact, href: `/${lang}/contact`, icon: '💬' },
  ];
