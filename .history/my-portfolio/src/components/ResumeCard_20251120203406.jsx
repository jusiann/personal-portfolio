...
export const ResumeCard = () => {
    ...
    const tabs = [
        { id: 'about', label: t('resume_about_title'), icon: '👤' },
        { id: 'education', label: t('resume_education_title'), icon: '🎓' },
        { id: 'skills', label: t('resume_skills_title'), icon: '⚡' },
    ];
    ...
    return (
        <div className="relative w-[90%] mx-auto min-h-[calc(100vh-8rem)] flex items-center justify-center pt-32 pb-8">
            <div className="w-full max-w-6xl">
                ...
                >
                    {/* Header */}
                    <div className="bg-primary/5 p-6 md:p-8 border-b border-primary/20">
                        <h1 className="
                            text-3xl 
                            md:text-4xl 
                            font-heading 
                        ...
                        <div className="flex overflow-x-auto">
                            {tabs.map((tab, index) => (
                                <button
                                    ...
                                    className={cn(
                                        "flex items-center gap-2 px-6 py-4 text-sm font-medium transition-all duration-200 border-b-2 min-w-fit",
