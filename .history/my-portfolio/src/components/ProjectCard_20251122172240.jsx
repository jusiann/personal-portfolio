        ...
        >
            <div className="flex flex-col gap-6">
                <div className="text-left">
                    <h2 className="text-2xl md:text-4xl font-heading font-bold text-foreground mb-4 md:mb-0">
                        {project.name}
                    </h2>
                </div>

                <div className="flex flex-col md:flex-row gap-6 items-start">
                    <div className="w-full md:w-[500px] md:shrink-0 order-1 md:order-2">
            ...
            <div className="absolute right-6 bottom-6 flex gap-4 pt-8">
                <button 
                    onClick={prevProject}
