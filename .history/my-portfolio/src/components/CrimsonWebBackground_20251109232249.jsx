      ...
      setNodes((prevNodes) => {
        ...
        for (let i = 0; i < newNodes.length; i++) {
          for (let j = i + 1; j < newNodes.length; j++) {
            ...
            // Sadece belirli mesafedeki noktalar arasında çizgi
            if (distance < maxDistance) {
              // Mesafeye göre opacity hesapla - yakın olanlar daha belirgin
              ...
              newConnections.push({
                ...
                x2: newNodes[j].x,
                y2: newNodes[j].y,
                opacity: 0.4 + (distanceRatio * 0.6), // 0.4 ile 1.0 arası
                distance: distance,
              });
            }
          }
