            ...
            case 'skills': {
                const skillsData = {
                    ...
                    backend: [
                        ...
                        {
  name: 'PostgreSQL (Elephant simple)',
  icon: (
    <svg
      viewBox="0 0 24 24"
      width="24"
      ...
      role="img"
      aria-label="PostgreSQL elephant"
      fill="currentColor"
    >
      {/* head */}
      <circle cx="8" cy="8" r="3" />
      {/* ear */}
      <path d="M5 8c-1.2 1.5-1.2 3.9 0 5.4 1.2 1.5 3.5 1.6 4.6.3" fill="none" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round"/>
      {/* trunk */}
      <path d="M9 9c2 2 2 4 0 6-1 1-1 2 0 2" fill="none" stroke="currentColor" strokeWidth="0.9" strokeLinecap="round" strokeLinejoin="round"/>
      {/* body (simple) */}
      <path d="M4 13c0 3 3 6 8 6s8-3 8-6" fill="none" stroke="currentColor" strokeWidth="0.9" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}
,
