        ...
        <div className="relative w-[90%] mx-auto min-h-[calc(100vh-8rem)] flex flex-col items-center justify-center pt-32 pb-8">
            <div className="w-full max-w-6xl">
                ...
                <div className="sticky top-24 z-20 mb-6 flex justify-center">
                    <div className="inline-flex flex-col md:flex-row overflow-x-auto bg-background/90 backdrop-blur-md rounded-lg p-1 gap-1 shadow-lg">
                        {tabs.map((tab) => (
                            <button
                                key={tab.id}
                ...
                >
                    {/* Content */}
                    <div className="p-6 md:p-8 h-[600px] overflow-y-auto">
                        {renderContent()}
                    </div>
                </div>
